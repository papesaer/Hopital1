...
<div class="row justify-content-center">
 ...
 <fieldset><legend>Le patient doit etre enregistrer
  ...
  <input type="time" name="Dated_RDV" class="form-control"  max="17" min="08">
  </div>
  </td>
  </tr>
  ...
  <button type="submit" class="btn btn-info"name="afficher"><a href="../view/listertRDV.php">afficher</button>
   </div>
   </fieldset>
    </form>
    </div>
