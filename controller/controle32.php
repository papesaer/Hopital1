...
<div class="row justify-content-center">
 ...
 <form method="POST" id="formulaire" action="controle32.php"> 
 ...
 <fieldset><legend>
  ...
  <input type="time" name="Heured_RDV" class="form-control" max="17" min="08">
  </div> 
  </td>
  <td>
  <div class="form-groupe">
  ...
  <button type="submit" class="btn btn-info"name="valider"><a href="../view/formulaire_medecin2.php">Ajouter</a></button>
  <button type="submit" class="btn btn-info"name="afficher"><a href="../view/jour_indispo1.php">afficher</button>
   </div>
   </fieldset>
    </form>
    </div>
