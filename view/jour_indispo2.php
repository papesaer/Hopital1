...
$sql="SELECT * FROM V_RDV_Patients_Inscrits WHERE id=id and Domaine='DODONTOLOGIE'";
                    ...
                    <div>
                     ...
                     <?php foreach($V_RDV_Patients_Inscrits  as $RDV):  ?>
                        ...
                        <tr>
                            ...
                            <a onclick="return confirm('Voulez vous vraiment supprimer?')" href="sup_c.php?id=<?=$RDV->id;?>" class="btn btn-danger">SUpprimer</a>
                            </td>
