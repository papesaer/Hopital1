  ...
  <div>
                            ...
                            <p>R-bonjour</p>
                              ...
                              <?php echo $_SESSION['prenom_inscrit'].''.$_SESSION['Nom_inscrit'];?><br>
                                ...
                                <form action = "../controller/verif-form333.php" method = "get" style=" position: relative;left:550px;top:-40px;">
...
<div class="row justify-content-center">
 ...
 <form method="POST" id="formulaire" action="../controller/controle3-333.php"> 
 ...
 <fieldset><legend>Le patient doit etre enregistrer
  ...
  <button type="submit" class="btn btn-info"name="afficher"><a href="listertRDV2.php">afficher</button>
   </div>
   </fieldset>
    </form>
    </div>
