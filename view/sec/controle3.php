<?php
 //modification 
  ...
  Adress_patient,Date_RDV,Heured_RDV,Nom_RDV,Heuref_RDV) VALUES (?,?,?,?,?,?,?,?,?,?,?)';
...
$_POST['Nom_RDV'],$_POST['Heuref_RDV']));
?>
                              ...
                              <?php echo $_SESSION['prenom_inscrit'].''.$_SESSION['Nom_inscrit'];?><br>
                                ...
                                <input type = "search" name = "terme">
                                 ...
                                 <INPUT TYPE="button"   Value="DECONNETION" onclick="window.location='index.php';"> 
                                  ...
                                  <INPUT TYPE="button"  Value="Voir agenda" onclick="window.location='jours 1.php';" 
...
<div class="row justify-content-center">
 ...
 <fieldset><legend>Le patient doit etre enregistrer
  ...
  <td>
  <div   class="form-groupe">
  <label for="utilise">Heure debut : </label>
  ...
  <td>
  <div class="form-groupe">
  <label for="utilise">Heure Fin : </label>
   <select name="Heuref_RDV"  class="form-control">
   <option value=""> 08:00</option>
   <option value=""> 08:15</option>
   <option value=""> 08:30</option>
   <option value=""> 08:45</option>
