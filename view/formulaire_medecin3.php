...
<div class="row justify-content-center">
 ...
 <form method="POST" id="formulaire" action="../controller/controle33.php"> 
 ...
 <fieldset><legend>
  ...
  <button type="submit" class="btn btn-info"name="afficher"><a href="jour_indispo2.php">afficher</button>
   </div>
   </fieldset>
    </form>
    </div>
